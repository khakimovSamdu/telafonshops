...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="contact-form-wrap">
                            <form action="contact-xabar-send.php" method="post" class="xabarformsend">
                                <div class="row">
                                    <div class="col-md-6">
                            ...
                            <button style="margin-top: 12px;" class="btn">Send Message</button>
                            </form>
                        </div>
    ...
    <script type="text/javascript">
        $('.xabarformsend').submit(function(e){
            e.preventDefault();
            $.ajax({
                url:"contact-xabar-send.php",
                method: "POST",
                data:$('.xabarformsend').serialize(),
