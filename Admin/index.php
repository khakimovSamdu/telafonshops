                    ...
                    <div class="category-content-wrap">
                        <div class="row">
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <!-- Category Item Start -->
                                <a href="telafon-brends.php" class="category-item">
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <!-- Category Item Start -->
                                <a href="telafon-brends.php" class="category-item color-2">
                                    <div class="category-icon">
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <!-- Category Item Start -->
                                <a href="telafon-brends.php" class="category-item color-3">
                                    <div class="category-icon">
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <!-- Category Item Start -->
                                <a href="telafon-brends.php" class="category-item color-4">
                                    <div class="category-icon">
