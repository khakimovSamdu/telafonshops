...
<body>
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="single-course">
                                                ...
                                                <div class="courses-content">
                                                    ...
                                                    <h3 class="title"><a href="telafon-brends.php"></a></h3>
                                ...
                                <div class="tab-pane fade show active" id="list">
                                    <div class="course-list-items">
                                            ...
                                            <div class="course-content">
                                                ...
                                                <div>
                                                <form action="buyurtma-berish.php" method="post" id="xarid">
                                                    <input type="hidden" name="id" value="<?=$fetch['id']?>">
                                                    <button class='btn btn-primery'  style='margin: 7px 2px; background-color: #0388fc'>Xarid berish</button> 
                                                </form>   
                                                </div>
                                                <div>
                                                    <button class='btn btn-danger'style='margin: 7px 2px; background-color: #f5c62c; width: 170px;' ><a  href="index.php">Cancel</a></button>   
                                                </div>
    ...
    <script type="text/javascript"> 
        $('#xarid').submit(function (e) {
            e.preventDefault();
            $.ajax({
                url: "buyurtma-berish.php",
                method: "POST",
                data: $('#xarid').serialize(),
                success:function(data){
                    obj =jQuery.parseJSON(data);
                    if(obj.xatolik == 0){
                        swal('Tabriklaymiz!', obj.xabar, 'success');
                    }else{
                        swal('Xatolik!', obj.xabar, 'error');
                    }
                },
                error:function(){
                    alert('Inernetingizda muammo bor tekshirib ko\'ring!');
                }
            });
        })
    </script>                                 
